...
book1 = Notebook.create!(name: 'People whose toes I hope become stubbed today.', user_id: 5)
book2 = Notebook.create!(name: 'People whose toes I hope DO NOT become stubbed today.', user_id: 5)
book3 = Notebook.create!(name: 'My favorite recipes', user_id: 5)
book4 = Notebook.create!(name: 'NY Football Giants Playbook', user_id: 5)
book5 = Notebook.create!(name: 'Legends of the Hidden Temple', user_id: 5)
book6 = Notebook.create!(name: 'My deepest darkest secrets', user_id: 5)
book7 = Notebook.create!(name: 'Everything Larry Bird', user_id: 5)
book8 = Notebook.create!(name: 'The Diaries of Sigourney Weaver', user_id: 5)
